$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_moz
...
*Define the years 2022-2030 as well as the starting and ending yearz
Set     t /2022*2050/
...
$CALL GDXXRW .\input\paraminput_moz.xlsx output=.\auxiliary\paraminput_moz.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_moz.gdx
...
$CALL GDXXRW .\auxiliary\datainput_moz.xlsx output=.\auxiliary\datainput_moz.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_moz.gdx
...
Execute_Unload '.\auxiliary\modeloutput_moz.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_moz.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_moz.gdx output=.\output\modeloutput_moz.xlsx @.\auxiliary\outputsetting_moz.txt';
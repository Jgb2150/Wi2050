...
$CALL GDXXRW .\input\mozambique_rawdata.xlsx output=".\auxiliary\mozambique_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\mozambique_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_moz.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_moz.gdx output=.\auxiliary\datainput_moz.xlsx @.\auxiliary\loadersetting.txt';

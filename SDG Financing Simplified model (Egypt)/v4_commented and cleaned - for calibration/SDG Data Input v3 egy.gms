...
$CALL GDXXRW .\input\egypt_rawdata.xlsx output=".\auxiliary\egypt_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\egypt_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_egy.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_egy.gdx output=.\auxiliary\datainput_egy.xlsx @.\auxiliary\loadersetting.txt';

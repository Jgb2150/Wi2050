$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_drc
...
$CALL GDXXRW .\input\paraminput_drc.xlsx output=.\auxiliary\paraminput_drc.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_drc.gdx
...
$CALL GDXXRW .\auxiliary\datainput_drc.xlsx output=.\auxiliary\datainput_drc.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_drc.gdx
...
Execute_Unload '.\auxiliary\modeloutput_drc.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_drc.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_drc.gdx output=.\output\modeloutput_drc.xlsx @.\auxiliary\outputsetting_drc.txt';
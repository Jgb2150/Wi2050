...
$CALL GDXXRW .\input\paraminput_bot.xlsx output=.\auxiliary\paraminput_bot.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_bot.gdx
...
$CALL GDXXRW .\auxiliary\datainput_bot.xlsx output=.\auxiliary\datainput_bot.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_bot.gdx
...
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_bot.gdx output=.\output\modeloutput_bot.xlsx @.\auxiliary\outputsetting_bot.txt';
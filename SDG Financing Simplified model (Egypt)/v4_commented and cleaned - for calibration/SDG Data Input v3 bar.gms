...
$CALL GDXXRW .\input\barbados_rawdata.xlsx output=".\auxiliary\barbados_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\barbados_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_bar.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_bar.gdx output=.\auxiliary\datainput_bar.xlsx @.\auxiliary\loadersetting.txt';

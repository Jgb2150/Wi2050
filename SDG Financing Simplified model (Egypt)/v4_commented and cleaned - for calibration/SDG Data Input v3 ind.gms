...
$CALL GDXXRW .\input\indonesia_rawdata.xlsx output=".\auxiliary\indonesia_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\indonesia_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_ind.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_ind.gdx output=.\auxiliary\datainput_ind.xlsx @.\auxiliary\loadersetting.txt';

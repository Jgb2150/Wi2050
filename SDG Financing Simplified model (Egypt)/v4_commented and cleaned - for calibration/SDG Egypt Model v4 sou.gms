$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_sou
...
$CALL GDXXRW .\input\paraminput_sou.xlsx output=.\auxiliary\paraminput_sou.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_sou.gdx
...
$CALL GDXXRW .\auxiliary\datainput_sou.xlsx output=.\auxiliary\datainput_sou.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_sou.gdx
...
Execute_Unload '.\auxiliary\modeloutput_sou.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_sou.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_sou.gdx output=.\output\modeloutput_sou.xlsx @.\auxiliary\outputsetting_sou.txt';
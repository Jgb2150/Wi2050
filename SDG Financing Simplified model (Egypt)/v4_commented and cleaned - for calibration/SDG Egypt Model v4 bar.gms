...
$CALL GDXXRW .\auxiliary\datainput_bar.xlsx output=.\auxiliary\datainput_bar.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_bar.gdx
...
Execute_Unload '.\auxiliary\modeloutput_bar.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_bar.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_bar.gdx output=.\output\modeloutput_bar.xlsx @.\auxiliary\outputsetting_bar.txt';
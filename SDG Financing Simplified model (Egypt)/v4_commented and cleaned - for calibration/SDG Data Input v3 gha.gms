...
$CALL GDXXRW .\input\ghana_rawdata.xlsx output=".\auxiliary\ghana_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\ghana_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_gha.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_gha.gdx output=.\auxiliary\datainput_gha.xlsx @.\auxiliary\loadersetting.txt';

...
$CALL GDXXRW .\input\botswana_rawdata.xlsx output=".\auxiliary\botswana_rawdata.gdx" Index=Index!a1 trace=3
...
execute_unload '.\auxiliary\datainput_bot.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_bot.gdx output=.\auxiliary\datainput_bot.xlsx @.\auxiliary\loadersetting.txt';

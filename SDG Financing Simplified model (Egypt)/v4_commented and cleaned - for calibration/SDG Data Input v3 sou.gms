...
$CALL GDXXRW .\input\southafrica_rawdata.xlsx output=".\auxiliary\southafrica_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\southafrica_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_sou.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_sou.gdx output=.\auxiliary\datainput_sou.xlsx @.\auxiliary\loadersetting.txt';

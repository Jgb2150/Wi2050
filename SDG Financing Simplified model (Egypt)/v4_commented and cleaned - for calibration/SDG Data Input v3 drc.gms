...
$CALL GDXXRW .\input\drc_rawdata.xlsx output=".\auxiliary\drc_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\drc_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_drc.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_drc.gdx output=.\auxiliary\datainput_drc.xlsx @.\auxiliary\loadersetting.txt';

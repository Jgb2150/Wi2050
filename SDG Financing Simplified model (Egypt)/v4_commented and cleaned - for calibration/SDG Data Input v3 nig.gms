...
$CALL GDXXRW .\input\nigeria_rawdata.xlsx output=".\auxiliary\nigeria_rawdata.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\nigeria_rawdata.gdx"
...
execute_unload '.\auxiliary\datainput_nig.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_nig.gdx output=.\auxiliary\datainput_nig.xlsx @.\auxiliary\loadersetting.txt';

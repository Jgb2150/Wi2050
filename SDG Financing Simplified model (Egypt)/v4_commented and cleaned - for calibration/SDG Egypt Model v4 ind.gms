$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_ind
...
$CALL GDXXRW .\input\paraminput_ind.xlsx output=.\auxiliary\paraminput_ind.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_ind.gdx
...
$CALL GDXXRW .\auxiliary\datainput_ind.xlsx output=.\auxiliary\datainput_ind.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_ind.gdx
...
Execute_Unload '.\auxiliary\modeloutput_ind.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_ind.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_ind.gdx output=.\output\modeloutput_ind.xlsx @.\auxiliary\outputsetting_ind.txt';
$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_gha
...
$CALL GDXXRW .\input\paraminput_gha.xlsx output=.\auxiliary\paraminput_gha.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_gha.gdx
...
$CALL GDXXRW .\auxiliary\datainput_gha.xlsx output=.\auxiliary\datainput_gha.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_gha.gdx
...
Execute_Unload '.\auxiliary\modeloutput_gha.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_gha.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_gha.gdx output=.\output\modeloutput_gha.xlsx @.\auxiliary\outputsetting_gha.txt';
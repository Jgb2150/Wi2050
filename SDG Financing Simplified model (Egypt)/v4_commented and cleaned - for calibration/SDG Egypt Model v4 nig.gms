$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_nig
...
$CALL GDXXRW .\input\paraminput_nig.xlsx output=.\auxiliary\paraminput_nig.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_nig.gdx
...
$CALL GDXXRW .\auxiliary\datainput_nig.xlsx output=.\auxiliary\datainput_nig.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_nig.gdx
...
Execute_Unload '.\auxiliary\modeloutput_nig.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_nig.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_nig.gdx output=.\output\modeloutput_nig.xlsx @.\auxiliary\outputsetting_nig.txt';
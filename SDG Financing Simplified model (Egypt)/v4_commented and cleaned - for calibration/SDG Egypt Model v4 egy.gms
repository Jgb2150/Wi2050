$title SDG Financing Simplified model Egypt_ commented and cleaned_v4_egy
...
$CALL GDXXRW .\input\paraminput_egy.xlsx output=.\auxiliary\paraminput_egy.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_egy.gdx
...
$CALL GDXXRW .\auxiliary\datainput_egy.xlsx output=.\auxiliary\datainput_egy.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput_egy.gdx
...
Execute_Unload '.\auxiliary\modeloutput_egy.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting_egy.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput_egy.gdx output=.\output\modeloutput_egy.xlsx @.\auxiliary\outputsetting_egy.txt';
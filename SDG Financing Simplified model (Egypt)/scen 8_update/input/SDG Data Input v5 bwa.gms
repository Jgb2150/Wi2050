...
$CALL GDXXRW .\rawdata\rawdata_bwa.xlsx output=".\auxiliary\rawdata_bwa.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_bwa.gdx"
...
execute_unload '.\auxiliary\datainput_bwa.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_bwa.gdx output=.\auxiliary\datainput_bwa.xlsx @.\auxiliary\loadersetting.txt';

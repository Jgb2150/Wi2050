...
$CALL GDXXRW .\rawdata\rawdata_nga.xlsx output=".\auxiliary\rawdata_nga.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_nga.gdx"
...
execute_unload '.\auxiliary\datainput_nga.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_nga.gdx output=.\auxiliary\datainput_nga.xlsx @.\auxiliary\loadersetting.txt';

$title SDG Egypt Model scen 8 arg
...
$CALL GDXXRW .\input\paraminput\paraminput_arg.xlsx output=.\input\auxiliary\paraminput_arg.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_arg.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_arg.xlsx output=.\input\auxiliary\datainput_arg.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_arg.gdx
...
ewage(e,t)..          wage(e,t) =e= (blab*q(t)/(lowerbound+efflabtot(t)))*exp(hcaccum*(years(e)));
...
Execute_Unload '.\input\auxiliary\modeloutput_arg.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_arg.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_arg.gdx output=.\output\modeloutput_arg.xlsx @.\input\auxiliary\outputsetting_arg.txt';
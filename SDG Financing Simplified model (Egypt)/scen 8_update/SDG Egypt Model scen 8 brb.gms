$title SDG Egypt Model scen 7 brb
$stitle Last Updated: August 26, 2022
...
$CALL GDXXRW .\input\paraminput\paraminput_brb.xlsx output=.\input\auxiliary\paraminput_brb.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_brb.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_brb.xlsx output=.\input\auxiliary\datainput_brb.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_brb.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_brb.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_brb.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_brb.gdx output=.\output\modeloutput_brb.xlsx @.\input\auxiliary\outputsetting_brb.txt';
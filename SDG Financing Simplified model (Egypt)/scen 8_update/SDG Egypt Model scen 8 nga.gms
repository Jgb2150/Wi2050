$title SDG Egypt Model scen 8 nga
...
$CALL GDXXRW .\input\paraminput\paraminput_nga.xlsx output=.\input\auxiliary\paraminput_nga.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_nga.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_nga.xlsx output=.\input\auxiliary\datainput_nga.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_nga.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_nga.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_nga.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_nga.gdx output=.\output\modeloutput_nga.xlsx @.\input\auxiliary\outputsetting_nga.txt';
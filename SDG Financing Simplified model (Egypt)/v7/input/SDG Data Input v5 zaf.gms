...
$CALL GDXXRW .\rawdata\rawdata_zaf.xlsx output=".\auxiliary\rawdata_zaf.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_zaf.gdx"
...
execute_unload '.\auxiliary\datainput_zaf.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_zaf.gdx output=.\auxiliary\datainput_zaf.xlsx @.\auxiliary\loadersetting.txt';

$title SDG Egypt Model v7 %country%
...
parameter   blab      blab coefficient on labor is remainder after subtract share for business capital infrastructure and energy
            disc(t)   Discount factor defined by interest rate and t%country%et year
            ;
...
positive variables    lfe(e,t)              Labor force as a function of education and year
                      ...
                      mpk(t)                M%country%inal product of capital
...
Equations 
                    ...
                    ewage(e,t)      Wage by education and time t given as m%country%inal cost of labor
                    ...
                    m%country%inalpk(t)   M%country%inal product of capital given as capital production over total capital
...
m%country%inalpk(t)..       mpk(t) =e= bk*q(t)/(0.0001 + k(t));

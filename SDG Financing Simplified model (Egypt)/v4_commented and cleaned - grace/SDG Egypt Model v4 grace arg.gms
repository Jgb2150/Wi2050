$title SDG Financing Simplified model Egypt_ commented and cleaned_v4
...
$CALL GDXXRW .\input\paraminput_arg.xlsx output=.\auxiliary\paraminput_arg.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput_arg.gdx

...
parameter bk, bkf, ben, k0, kf0, debtqlim, costff, costre, dep, r, kff0, kre0, aff, taxlim, min0, land0, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound, continuation(a, conti);

$CALL GDXXRW mydatainputv2.xlsx Index=Index!a1 trace=3
$GDXIN mydatainputv2.gdx
$LOAD bk bkf ben k0 kf0 debtqlim costff costre dep r kff0 kre0 aff taxlim min0 land0 tfp1 phi fertsh gcostsh pubgdpsh lowerbound continuation
$GDXIN
...
display bk, bkf, ben, k0, kf0, debtqlim, costff, costre, dep, r, kff0, kre0, aff, taxlim, min0, land0, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound;
...
*eq39(t), eq40(t), eq41(t), eq42(t), eq43(t), eq44(t), eq45(t), eq46(t), eq47(t),eq48(t),eq49(t),
eq50, eq51(t), eq52(a,t), eq53(t),eq54(t),eq30a(t),eq21a(t),
...
display qpc.L, edcostgdp.L, hlcostgdp.L, invfgdp.L, outlaygdp.L, poptotp, poptot.L;
...
set outputvarlist /qpc, edcostgdp, hlcostgdp, invfgdp, outlaygdp/;
parameter outputvar(outputvarlist, t);
        outputvar("qpc", t) = qpc.L(t);
        outputvar("edcostgdp", t) = edcostgdp.L(t);
        outputvar("hlcostgdp", t) = hlcostgdp.L(t);
        outputvar("invfgdp", t) = invfgdp.L(t);
        outputvar("outlaygdp", t) = outlaygdp.L(t);

Execute_Unload 'mydataoutputv2.gdx', outputvar;

$onEcho > outputsetting.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE mydataoutputv2.gdx @outputsetting.txt';
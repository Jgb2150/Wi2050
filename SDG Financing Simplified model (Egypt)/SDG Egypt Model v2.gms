...
parameter bk, bkf, ben, k0, kf0, debtqlim, ek, costff, costre, dep, r, kff0, kre0, aff, taxlim, min0, land0, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound, continuation(a, conti);

$CALL GDXXRW mydatainputv2.xlsx Index=Index!a1 trace=3
$GDXIN mydatainputv2.gdx
$LOAD bk bkf ben k0 kf0 debtqlim ek costff costre dep r kff0 kre0 aff taxlim min0 land0 tfp1 phi fertsh gcostsh pubgdpsh lowerbound continuation
$GDXIN
...
display bk, bkf, ben, k0, kf0, debtqlim, ek, costff, costre, dep, r, kff0, kre0, aff, taxlim, min0, land0, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound;

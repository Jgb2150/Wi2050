$title SDG Egypt Model scen 8 moz
...
$CALL GDXXRW .\input\paraminput\paraminput_moz.xlsx output=.\input\auxiliary\paraminput_moz.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_moz.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_moz.xlsx output=.\input\auxiliary\datainput_moz.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_moz.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_moz.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_moz.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_moz.gdx output=.\output\modeloutput_moz.xlsx @.\input\auxiliary\outputsetting_moz.txt';
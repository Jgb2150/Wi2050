$title SDG Egypt Model scen 8 idn
...
$CALL GDXXRW .\input\paraminput\paraminput_idn.xlsx output=.\input\auxiliary\paraminput_idn.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_idn.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_idn.xlsx output=.\input\auxiliary\datainput_idn.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_idn.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_idn.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_idn.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_idn.gdx output=.\output\modeloutput_idn.xlsx @.\input\auxiliary\outputsetting_idn.txt';
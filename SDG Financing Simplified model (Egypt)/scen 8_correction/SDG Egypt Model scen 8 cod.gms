$title SDG Egypt Model scen 8 cod
...
$CALL GDXXRW .\input\paraminput\paraminput_cod.xlsx output=.\input\auxiliary\paraminput_cod.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_cod.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_cod.xlsx output=.\input\auxiliary\datainput_cod.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_cod.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_cod.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_cod.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_cod.gdx output=.\output\modeloutput_cod.xlsx @.\input\auxiliary\outputsetting_cod.txt';
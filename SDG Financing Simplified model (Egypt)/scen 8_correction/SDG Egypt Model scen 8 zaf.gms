$title SDG Egypt Model scen 8 zaf
...
$CALL GDXXRW .\input\paraminput\paraminput_zaf.xlsx output=.\input\auxiliary\paraminput_zaf.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_zaf.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_zaf.xlsx output=.\input\auxiliary\datainput_zaf.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_zaf.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_zaf.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_zaf.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_zaf.gdx output=.\output\modeloutput_zaf.xlsx @.\input\auxiliary\outputsetting_zaf.txt';
...
$CALL GDXXRW .\rawdata\rawdata_brb.xlsx output=".\auxiliary\rawdata_brb.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_brb.gdx"
...
execute_unload '.\auxiliary\datainput_brb.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_brb.gdx output=.\auxiliary\datainput_brb.xlsx @.\auxiliary\loadersetting.txt';

...
$CALL GDXXRW .\rawdata\rawdata_cod.xlsx output=".\auxiliary\rawdata_cod.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_cod.gdx"
...
execute_unload '.\auxiliary\datainput_cod.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_cod.gdx output=.\auxiliary\datainput_cod.xlsx @.\auxiliary\loadersetting.txt';

$title SDG Egypt Model scen 8 egy
...
$CALL GDXXRW .\input\paraminput\paraminput_egy.xlsx output=.\input\auxiliary\paraminput_egy.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_egy.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_egy.xlsx output=.\input\auxiliary\datainput_egy.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_egy.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_egy.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_egy.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_egy.gdx output=.\output\modeloutput_egy.xlsx @.\input\auxiliary\outputsetting_egy.txt';
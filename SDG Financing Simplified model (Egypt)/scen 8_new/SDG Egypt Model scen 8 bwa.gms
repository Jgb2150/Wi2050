$title SDG Egypt Model scen 7 bwa
...
$CALL GDXXRW .\input\paraminput\paraminput_bwa.xlsx output=.\input\auxiliary\paraminput_bwa.gdx Index=Index!a1 trace=3
$GDXIN .\input\auxiliary\paraminput_bwa.gdx
...
$CALL GDXXRW .\input\auxiliary\datainput_bwa.xlsx output=.\input\auxiliary\datainput_bwa.gdx Index=index!a1 trace=3
$GDXIN .\input\auxiliary\datainput_bwa.gdx
...
Execute_Unload '.\input\auxiliary\modeloutput_bwa.gdx', outputvar;

$onEcho > .\input\auxiliary\outputsetting_bwa.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\input\auxiliary\modeloutput_bwa.gdx output=.\output\modeloutput_bwa.xlsx @.\input\auxiliary\outputsetting_bwa.txt';
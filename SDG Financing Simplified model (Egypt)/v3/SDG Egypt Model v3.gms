...
parameter bk, bkf, ben, k0, kf0, debtqlim, costff, costre, dep, r, kff0, kre0, aff, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound, continuation(a, conti);

$CALL GDXXRW .\input\paraminput.xlsx output=.\auxiliary\paraminput.gdx Index=Index!a1 trace=3
$GDXIN .\auxiliary\paraminput.gdx
$LOAD bk bkf ben k0 kf0 debtqlim costff costre dep r kff0 kre0 aff tfp1 phi fertsh gcostsh pubgdpsh lowerbound continuation
$GDXIN
...
display bk, bkf, ben, k0, kf0, debtqlim, costff, costre, dep, r, kff0, kre0, aff, tfp1, phi, fertsh, gcostsh, pubgdpsh, lowerbound;

parameter popg0(a,g),fert0(a,fer),surv0(a,surv),w0(a,a,g),s0(a,g),ferthic0(a,fer),tfp(sec);

$CALL GDXXRW .\auxiliary\datainput.xlsx output=.\auxiliary\datainput.gdx Index=index!a1 trace=3
$GDXIN .\auxiliary\datainput.gdx
...
lqp(t),lsub(t), gov(t),gdptot(t), pn(t), debt(t), debtgdp(t), cont12(t), govgdp(t), reserve(t), edcost(t), hlcost(t), healthpc(t), hlcostgdp(t),
schoolpop(t), schooltsa(t), cont(a,t), s(a,g,t), leave(a,a,g,t),neet(a,a,t), school(e,t), schooltot(t), schoolc(t), ps(t),ls(t),us(t),ts(t),lse(t), use(t), tse(t),
...
eq34(t),
eq36(a,g), eq37(a,g), eq38(a,a,g),
*eq39(t), eq40(t), eq41(t), eq42(t), eq43(t), eq44(t), eq45(t), eq46(t), eq47(t),eq48(t),eq49(t), eq50,
eq51(t), eq52(a,t), eq53(t), eq54(t),eq30a(t),eq21a(t),
*eq55(t),eq56(t),eq57(t),eq58(t),eq59(t), eq60(t),
...
krenext(t),
kfend(t), energy(t), ffuel(t), conlim(t), education(t), edugdp(t),
...
parameter outputvar(outputvarlist, t);
        ...
        outputvar("Education Cost (%GDP)", t) = edcostgdp.L(t);
...
Execute_Unload '.\auxiliary\modeloutput.gdx', outputvar;

$onEcho > .\auxiliary\outputsetting.txt
par=outputvar
$offEcho
Execute 'GDXXRW.EXE .\auxiliary\modeloutput.gdx output=.\output\modeloutput.xlsx @.\auxiliary\outputsetting.txt';
...
$CALL GDXXRW .\rawdata\rawdata_idn.xlsx output=".\auxiliary\rawdata_idn.gdx" Index=Index!a1 trace=3
$GDXIN ".\auxiliary\rawdata_idn.gdx"
...
execute_unload '.\auxiliary\datainput_idn.gdx' popg0,fert0,ferthic0,surv0,w0,s0;
...
$offEcho
execute 'gdxxrw .\auxiliary\datainput_idn.gdx output=.\auxiliary\datainput_idn.xlsx @.\auxiliary\loadersetting.txt';

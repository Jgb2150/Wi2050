$title SDG Egypt Model v8 zaf
$stitle Last Updated: August 20, 2022
...
$LOAD bk bkf ben k0 kf0 debtqlim costff costre dep r discr kff0 kre0 aff tfp1 phi stratio hwratio hcaccum fertsh pubgdpsh lowerbound continuation
$GDXIN
...
display bk, bkf, ben, blab, k0, kf0, debtqlim, costff, costre, dep, r, discr, kff0, kre0, aff, tfp1, phi, stratio, hwratio, hcaccum, fertsh, pubgdpsh, lowerbound;
...
parameter outputvar(outputvarlist, t);
        ...
        outputvar("Total Energy Capital", t) = en.L(t);
        outputvar("Total Infrastructure Capital", t) = kf.L(t);
        outputvar("Total Business Capital", t) = k.L(t);
        outputvar("Total Capital", t) = ktot.L(t);
        outputvar("Total Investment", t) = invtot.L(t);
        outputvar("Debt Level", t) = debt.L(t);
        outputvar("Debt to GDP", t) = debtgdp.L(t);
        outputvar("Fossil Fuel Cost", t) = ff.L(t);
        outputvar("Healthcare Cost as % GDP", t) = hlcostgdp.L(t);
        outputvar("Education Cost as % GDP", t) = edcostgdp.L(t);
        outputvar("Public Admin Cost as % GDP", t) = pubgdp.L(t);

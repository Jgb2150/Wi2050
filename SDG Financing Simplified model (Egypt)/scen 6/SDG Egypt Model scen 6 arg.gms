$title SDG Egypt Model scen 5 arg
$stitle Last Updated: August 22, 2022
...
endconpclim..         conpc("2050") =g= conpc("2049");
...
utility..             util =e= sum(t,disc(t)* ut(t)) + (1/discr)*sum(tend, disc(tend)*(sum(t, ord(t)**2*ut(t))/sum(t, ord(t)**2)));
governgdp(t)..        govgdp(t) =e= gov(t)/q(t);
taxmax(t)..           govgdp(t) =l= taxlim;
govbudget(t)..        gov(t) =e= edcost(t)+hlcost(t)
